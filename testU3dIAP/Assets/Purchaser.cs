...
public class Purchaser : MonoBehaviour, IStoreListener
{
	...
	private static string kProductNameAppleConsumable = "com.zzw.test.item1";
	// Apple App Store identifier for the consumable product.
	private static string kProductNameAppleNonConsumable = "com.zzw.test.item2";
	...
	private static string kProductNameGooglePlayConsumable = "com.zzw.test.item1";
	// Google Play Store identifier for the consumable product.
	private static string kProductNameGooglePlayNonConsumable = "com.zzw.test.item3";
	// Google Play Store identifier for the non-consumable product.
	private static string kProductNameGooglePlaySubscription = "com.zzw.test.item2";
